<template>
  <div @click="runAudioEffect">
    <svg width="801" height="801" viewBox="0 0 801.000000 801.000000"
      ...
      <g>
        <title>Layer 1</title>
        <g transform="translate(0,801) scale(0.10000000149011612,-0.10000000149011612) " fill="#000000" id="svg_1">
...
export default {
  ...
  methods: {
    runAudioEffect() {
      document.body.click();
      const audio = new Audio(require(`../../../assets/sounds/1-30.wav`));
      audio.play();
    }
  },
};
